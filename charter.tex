...
\begin{enumerate}
\item Planificación del proyecto (suma h)
	\begin{enumerate}
	\item Definición de especificaciones y requerimientos (tantas h)
	\item Definición de alcance del proyecto (tantas h)
	\item Revisión de viabilidad técnica (tantas h)
	\item Generación de diagrama de actividades (tantas h)
	\item Generación de diagrama de Gantt (tantas h)
	\item Análisis presupuestario del proyecto (tantas h)
	\item Definición de riesgos y contingencias  (tantas h)
	\item Gestión de calidad (tantas h)
	\item Presentación y exposición del proyecto (tantas h)
	\end{enumerate}
\item Diseño de hardware (suma h)
	\begin{enumerate}
	\item Análisis, selección y adquisición de componentes (tantas h)
	\item Diseño de esquemáticos (tantas h)
	\item Optimización del diseño del PCB para montaje en carcasa (tantas h)
	\item Diseño del PCB (tantas h)
	\item Generación de archivos de fabricación (tantas h)
	\item Validación, cotización y pedido de fabricación
	\end{enumerate}
\item Validación de hardware del prototipo (suma h)
	\begin{enumerate}
	\item Soldado de componentes que no hayan sido ensamblados por el fabricante (tantas h)
	\item Limpieza, validación e inspección de conexiones del PCB (tantas h)
	\item Pruebas de integridad eléctrica y aislamiento (tantas h)
	\end{enumerate}
\item Desarrollo del firmware (suma h)
	\begin{enumerate}
	\item Implementación del RTOS (tantas h)
	\item Implementación del protocolo de comunicación para la red mesh (tantas h)
	\item Implementación de interfaz de conexión a internet por Wi-Fi (tantas h)
	\item Implementación de interfaz de conexión a internet por red celular (tantas h)
	\item Implementación de manejador de conexiones a internet (tantas h)
	\item Implementación de la adquisición y gestión de los datos provenientes del sensor fotosensible (tantas h)
	\item Implementación de la lógica de control de intensidad lumínica mediante circuito dimmer (tantas h)
	\item Implementación del control del relé para habilitación/deshabilitación de la luminaria (tantas h)
	\item Implementación de control del módulo GPS (tantas h)
	\item Implementación de adquisición y gestion de los datos de consumo eléctrico enviados por el sensor de efecto hall (tantas h)
	\item Implementación de adquisición y gestion del dato de presencia o ausencia de tensión alterna enviado por el optoacoplador (tantas h)
	\item Implementación de adquisición y gestión de la tensión de batería (tantas h)
	\item Implementación de la actualización OTA del firmware (tantas h)
	\item Pruebas unitarias y de integración del firmware (tantas h)
	\end{enumerate}
\item \textbf{Validación del sistema} (suma h)
	\begin{enumerate}
	\item Pruebas funcionales del sistema completo (tantas h)
	\item Pruebas de comunicación y conectividad (Wi-Fi, celular, mesh) (tantas h)
	\item Validación del sistema en diferentes condiciones de operación (tantas h)
	\item Ajustes y optimizaciones finales (tantas h)
	\end{enumerate}
\item \textbf{Documentación final} (suma h)
	\begin{enumerate}
	\item Redacción de la documentación técnica del hardware (tantas h)
	\item Redacción de la documentación técnica del firmware (tantas h)
	\item Redacción del informe final del proyecto (tantas h)
	\item Generación de manuales de usuario e instalación (tantas h)
	\end{enumerate}
\end{enumerate}
\begin{consigna}{red}
