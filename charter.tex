...
\begin{itemize}
        ...
        \item \textbf{Utilización de circuito adaptador de señales para control de la luminaria}: Adaptará las se˜nales de control.
        ...
        \item \textbf{Red mesh}: Implementación de la red mesh en 915 MHz (ya existente en otros productos de la empresa) que permita la comunicación entre dispositivos CityLight. 
