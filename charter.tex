...
\item Planificación del proyecto (suma h)
	\begin{enumerate}
	\item Definición de proyecto, alcance, requerimientos, WBS y plan de trabajo (tantas h)
...
\item Diseño de hardware (suma h)
	...
	\end{enumerate}
\item Validación del hardware del prototipo (suma h)
	\begin{enumerate}
	\item Soldado de componentes que no se hayan sido ensamblados por el fabricante (tantas h)
...
\item Desarrollo del firmware (suma h)
	...
	\item Implementación de interfaz de conexión a internet por Wi-Fi
	\item Implementación de interfaz de conexión a internet por red celular
	\item Implementación de interfaz de conexión a internet por Wi-Fi
	\item Implementación de manejador de conexiones a internet
	\item Implementación de la gestión del sensor fotosensible (tantas h)
	...
	\item Implementación de la lógica para conmutación de fuentes de alimentación (red eléctrica/batería) (tantas h)
