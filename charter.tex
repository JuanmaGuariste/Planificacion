...
\end{table}
Para calcular los \textit{story points}, se suman los valores asignados a cada categoría y el resultado se aproxima al siguiente número de la serie de Fibonacci. Por ejemplo, si la complejidad del trabajo es media (5), la dificultad es alta (5) y la incertidumbre es media (3), los \textit{story points} serían 21 (5 + 5 + 3 = 13, que se aproxima al siguiente número de Fibonacci, que es 21).
...
\textit{Story points}: 21 (complejidad: 5, dificultad: 5, incertidumbre: 3)
